      ...
      <ContentContainer>
        ...
        <NotificationContainer>
          <Notification>
            <h3 id="-">탈퇴 안내</h3>
            <p>
              회원님께서 COTATO 동아리 페이지의 회원 탈퇴를 진행하실 경우, 아래 사항에 따라 모든
              정보가 삭제되며, 복구가 불가능하니 탈퇴를 신청하기 전에 안내 사항을 꼭 확인해주세요.
            </p>
            <ol>
              <li>
                <p>
                  부원 활동 정보 삭제
                  <p>
                    회원 탈퇴가 완료되면, 동아리 활동 내역, 기여 기록 등 부원 활동과 관련된 모든
                    정보가 삭제됩니다. 삭제된 정보는 다시 복구할 수 없으니 주의해 주세요.
                  </p>
                </p>
              </li>
              <li>
                <p>
                  개인 문제 풀이 내역 삭제
                  <p>
                    탈퇴와 함께 회원님의 개인 문제 풀이 내역이 삭제됩니다. 과거의 퀴즈 답변 기록,
                    풀이 점수 등 동아리 내 학습 활동에 관련된 모든 데이터가 삭제되며, 삭제된 내역은
                    다시 되돌릴 수 없습니다.
                  </p>
                </p>
              </li>
              <li>
                <p>
                  복구 불가 안내
                  <p>
                    탈퇴 요청이 접수되면, 회원님의 데이터는 즉시 삭제 처리되며 복구가 불가능합니다.
                    탈퇴 후 다시 참여를 원하실 경우, 신규 가입을 통해 새로운 계정을 생성하셔야
                    합니다.
                  </p>
                </p>
              </li>
