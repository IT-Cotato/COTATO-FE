...
const renderPersonalLocationNotification = () => {
  return (
    <>
      <h2 style={{ margin: 0 }}>개인위치정보 수집 및 이용</h2>
      <p>
      ...
      <ol>
        ...
        <li>
          개인위치정보 사용 방법 : 출석 체크 시에만 사용되며, 다른 목적으로 사용되지 않습니다. 출석
          확인 후 정보가 저장되지 않으며, 즉시 삭제됩니다.
        </li>
        <li>보유 및 이용 기간: 회원 탈퇴 시까지</li>
      </ol>
      <p>
      ...
      <p style={{ marginBottom: 0 }}>*수집된 정보는 동아리 활동 종료 시 폐기 됩니다. </p>
    </>
  );
};
