...
export type CotatoCommonColorType = {
  real_white: string;
  white: string;
  black: string;
};

export type CotatoOtherColorType = {
  gray5: string;
  gray10: string;
  gray20: string;
  gray30: string;
...
export type CotatoColorType = CotatoOtherColorType & {
  common: CotatoCommonColorType;
  const: CotatoCommonColorType & CotatoOtherColorType;
};
